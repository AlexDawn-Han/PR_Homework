...
if LABEL_NAME == 'car':
    n_components = 1024
    pos_features_path = os.path.join(DATASET_PATH, 'car_pos_features.npy')
    neg_features_path = os.path.join(DATASET_PATH, 'car_neg_features.npy')
    output_pos_file_name = 'car_pos_features.npy'
    output_neg_file_name = 'car_neg_features.npy'
    pca_model_save_path = 'car_pca_model.joblib'
    label_save_path = os.path.join(DATASET_PATH, 'car_labels_shuffle.npy')
    pac_features_save_path = os.path.join(DATASET_PATH, 'car_pca_features.npy')
    output_file_name = 'car_svm_model.pkl'
elif LABEL_NAME == 'licence':
    n_components = 512
    pos_features_path = os.path.join(DATASET_PATH, 'licence_pos_features.npy')
    neg_features_path = os.path.join(DATASET_PATH, 'licence_neg_features.npy')
    output_pos_file_name = 'licence_pos_features.npy'
    output_neg_file_name = 'licence_neg_features.npy'
    pca_model_save_path = 'licence_pca_model.joblib'
    label_save_path = os.path.join(DATASET_PATH, 'licence_labels_shuffle.npy')
    pac_features_save_path = os.path.join(DATASET_PATH, 'licence_pca_features.npy')
