...
if LABEL_NAME == 'car':
    pos_dataset_path = os.path.join(dataset_path, 'car_pos_1')
    neg_dataset_path = os.path.join(dataset_path, 'car_neg_n')
    ...
    pos_dataset_path = os.path.join(dataset_path, 'licence_pos_1')
    neg_dataset_path = os.path.join(dataset_path, 'licence_neg_n')
...
if __name__ == "__main__":
    ...
    np.save(os.path.join(dataset_path,output_pos_file_name), pos_features)
    
    # 提取负样本特征
    neg_features = img2feature_parallel(neg_dataset_path, neg_dataset_path)
    np.save(os.path.join(dataset_path,output_neg_file_name), neg_features)